...
! if you want to add your model add the new parameters in the following slot:
!--------------
! new params:
...
!contains
! Subroutine for computing mu, gamma mudot and

!subroutine mgfunctions()
!use precision
!integer model
!real(dl), intent(in) :: a, H0,
!real(dl), intent(out) :: mu, mudot, gamma, gammadot !principal MG functions
!real(dl) :: m, beta, mdot, betadot



!end subroutine mgfunctions
